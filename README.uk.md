...
Адаптивне двомовне портфоліо та онлайн-резюме, створене без фреймворків і етапу збирання. Інтерфейс у стилі редактора поєднує навігацію за розділами, картки проєктів, рухому стрічку технологій і власну систему локалізації на основі XML.
...
- Односторінкове компонування з навігацією за розділами на комп’ютері й телефоні.
- Картки проєктів, рухома стрічка технологій і компактна хронологія освіти.
...
Сторінка використовує CSS-переходи, рухому стрічку технологій і систему появи елементів на основі `IntersectionObserver`. Анімації залишаються декоративними, а медіазапит `prefers-reduced-motion` вимикає необов’язкові ефекти для відвідувачів, які віддають перевагу мінімальному руху.
...
├── style.css                 # Компонування, адаптивність та анімації
...
└── res
    ...
    ├── scripts                # Локалізація, інтерактивність, стрічка технологій і звук
    └── locales
